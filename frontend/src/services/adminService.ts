...
export const getAllSwapsAdmin = async (): Promise<any[]> => {
  const response = await api.get('/admin/swaps');
  return response.data;
};

// Get all feedback (admin view)
export const getAllFeedbackAdmin = async (): Promise<any[]> => {
  const response = await api.get('/admin/feedback');
  return response.data;
};

// Create admin message
export const createAdminMessage = async (data: CreateMessageData): Promise<AdminMessage> => {
...
export const updateAdminMessage = async (messageId: string, data: Partial<CreateMessageData>): Promise<AdminMessage> => {
